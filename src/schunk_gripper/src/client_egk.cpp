...
/*
#include "ros/ros.h"
#include "schunk_gripper/gripAction.h"
#include "schunk_gripper/grip_with_posAction.h"
...
void doneCb(const actionlib::SimpleClientGoalState &state,const schunk_gripper::gripResultConstPtr& msg)
{
...
int main(int argc, char** argv)
{
    ...
    actionlib::SimpleActionClient<schunk_gripper::gripAction>              grip_client("grip_egk", true);
    actionlib::SimpleActionClient<schunk_gripper::grip_with_posAction>     grp_w_pos_client("grip_with_pos_egk", true);
